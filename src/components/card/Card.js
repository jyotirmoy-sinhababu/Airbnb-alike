  ...
  return (
    <>
      ...
      <div className='card-dtls'>
        <div className='card-dtls-first'>
          {data.superHost ? (
            <div className='card-superHost-cnt'>
              <p className='card-heading'>SUPER HOST</p>
            </div>
          ) : null}
          <p className='card-type'>{data.type}</p>
          {data.beds ? <p className='card-bed'>.{data.beds} beds</p> : null}
        </div>
        <div className='card-dtls-second'>
